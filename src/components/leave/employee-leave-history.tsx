...
import { getEmployeeLeaveHistory, type LeaveRequestWithDetails } from '@/lib/leave'
...
export function EmployeeLeaveHistory({ employeeId, onRefresh }: EmployeeLeaveHistoryProps) {
  ...
  const fetchLeaveHistory = useCallback(async () => {
    try {
      setIsLoading(true)
      const data = await getEmployeeLeaveHistory(employeeId)
      setRequests(data)
